...
class _Mes_depanneursPageState extends State<Mes_depanneursPage> {
  ...
  void initState() {
    ...
    if(currUser.isChan=='true'){
      collectionusers = FirebaseFirestore.instance.collection('Mes_depanneurs_chan');
    }
  }
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body:  Padding(
          ...
          child: StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance.collection(currUser.isChan=='true'?"Mes_depanneurs_chan":"Mes_depanneurs").snapshots(),
