...
import 'package:map/Screens/login/components/Email.dart';
import 'package:map/Screens/login/components/Password.dart';
import 'package:map/Screens/signup/components/Adresse.dart';
import 'package:map/Screens/signup/components/Prenom.dart';
import 'package:map/Screens/signup/components/nom.dart';
import 'package:map/components/background.dart';
 ...
 Future<void> AddDepanneur()async{
  ...
  void initState() {
    ...
    if(currUser.isChan=='true'){
       depanColl = FirebaseFirestore.instance.collection('Mes_depanneurs_chan');
    }
